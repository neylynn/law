                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <router-link to="/articles" class="btn btn-sm btn-primary">
...
<script>
    export default {
            ...
            mounted () {
                axios
                    .get(`http://law.test/api/article/edit/${this.$route.params.id}`)
                    .then((response) => {
            ...
            methods: {
                onUpdate() {
                    this.form
                        .post(`http://law.test/api/article/update/${this.$route.params.id}`, this.article)
                        .then(() => {
                            Toast.fire({
                                icon: 'success',
